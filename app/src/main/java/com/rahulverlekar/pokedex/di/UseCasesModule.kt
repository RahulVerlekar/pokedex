...
object UseCasesModule {
    ...
    @Provides
    fun providePokemonUseCases(network: PokeDexNetworkRepo, local: PokeDexDB, keyValueStorage: KeyValueStorage): PokeDexUseCases = PokeDexUseCasesImpl(network, local, keyValueStorage)
}